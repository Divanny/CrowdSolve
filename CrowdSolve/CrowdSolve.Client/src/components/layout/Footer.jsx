            ...
            <div className="flex flex-col lg:flex-row justify-between">
                ...
                <div className="flex flex-col sm:flex-row justify-end lg:w-2/3 space-y-8 sm:space-y-0 sm:space-x-12 lg:space-x-24">
                    ...
                    <div>
                        ...
                        <ul className="space-y-2">
                            <li><Link href="/sobre-nosotros" className="text-sm text-muted-foreground hover:text-primary transition-colors">{t('footer.sections.company.links.aboutUs')}</Link></li>
                            ...
                            <li><Link href="/contacto" className="text-sm text-muted-foreground hover:text-primary transition-colors">{t('footer.sections.company.links.contact')}</Link></li>
                        </ul>
                    </div>
                </div>
            </div>
