...
export const ColumnGroupElement = withRef(({ children, className, ...props }, ref) => {
  return (
  ...
  return (
    (<Popover open={isOpen} modal={false}>
      ...
      <PopoverContent
        ...
        sideOffset={10}>
        <div
          className="box-content flex items-center [&_svg]:size-4 [&_svg]:text-muted-foreground">
          ...
          <Button size="icon" variant="ghost" onClick={setRightSideDoubleColumn}>
            <RightSideDoubleColumnOutlined />
          </Button>
          <Button size="icon" variant="ghost" onClick={setLeftSideDoubleColumn}>
            <LeftSideDoubleColumnOutlined />
          </Button>
          <Button size="icon" variant="ghost" onClick={setDoubleSideDoubleColumn}>
