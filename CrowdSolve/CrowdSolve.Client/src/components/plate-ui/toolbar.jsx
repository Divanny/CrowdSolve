...
const toolbarButtonVariants = cva(cn(
...
const ToolbarButton = withTooltip(// eslint-disable-next-line react/display-name
React.forwardRef((
...
export const ToolbarGroup = withRef(({ children, className }, ref) => {
  return (
    (<div
      ref={ref}
